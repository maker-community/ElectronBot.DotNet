using Verdure.NotificationArea.Dialogs.FileDialog.Native;
using System;
using System.Runtime.InteropServices;

namespace Verdure.NotificationArea.Dialogs;
...
public class FolderPickerDialog
{
    ...
    public bool ShowDialog(IntPtr hwnd)
    {
        ...
        try
        {
            if (hwnd == IntPtr.Zero)
            {
                hwnd = User32.User32Library.GetForegroundWindow();
            }
            ...
            {
                item = Shell32.Shell32Library.SHCreateItemFromParsingName(Path, IntPtr.Zero, typeof(IShellItem).GUID);
