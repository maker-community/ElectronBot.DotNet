using Verdure.NotificationArea.Shell32;
using Verdure.NotificationArea.User32;
using Verdure.NotificationArea.WindowsCore;
using System;
using System.Runtime.InteropServices;

namespace Verdure.NotificationArea;
...
public class NotificationAreaIcon : IDisposable
{
    ...
    private IntPtr NotificationAreaMenu { get; set; }
    ...
    public NotificationAreaIcon(string iconFile, string title)
    {
    ...
    /// 初始化托盘图标扩展菜单
    /// </summary>
    public void InitializeNotificationAreaMenu()
    {
        NotificationAreaMenu = User32Library.CreatePopupMenu();
    }
    ...
    {
        if (NotificationAreaMenu != IntPtr.Zero)
        {
            ...
            return User32Library.InsertMenuItem(NotificationAreaMenu, menuIndex++, true, ref menuItem);
        }
        else
        {
            return false;
    ...
    public void ShowContextMenu()
    {
        ...
        int menuid = User32Library.TrackPopupMenu(NotificationAreaMenu, TrackPopupMenuFlags.TPM_LEFTALIGN | TrackPopupMenuFlags.TPM_RIGHTBUTTON | TrackPopupMenuFlags.TPM_RETURNCMD | TrackPopupMenuFlags.TPM_NONOTIFY, CurrentPoint.x, CurrentPoint.y, 0, messageSink.MessageWindowHandle, IntPtr.Zero);
    ...
    private void Dispose(bool disposing)
    {
        ...
        if (NotificationAreaMenu != IntPtr.Zero)
        {
            User32Library.DestroyMenu(NotificationAreaMenu);
        }
