...
public partial class MovieViewModel : ObservableRecipient
{
    ...
    {
        Ioc.Default.GetRequiredService<ICompositorProvider>().GetWindow().DispatcherQueue.TryEnqueue(async () =>
        {
            try
            {
    ...
    private void Setup()
    {
        ...
        _compositionGraphicsDevice = CanvasComposition.CreateCompositionGraphicsDevice(
            Ioc.Default.GetRequiredService<ICompositorProvider>().GetWindow().Compositor, _canvasDevice);

        _compositor = Ioc.Default.GetRequiredService<ICompositorProvider>().GetWindow().Compositor;
        ...
        ElementCompositionPreview.SetElementChildVisual(Ioc.Default.GetRequiredService<ICompositorProvider>().GetWindow().Content, visual);
    }
    ...
    public async Task StartCaptureAsync()
    {
        ...
        // file pickers do.
        var hwnd = WindowNative.GetWindowHandle(Ioc.Default.GetRequiredService<ICompositorProvider>().GetWindow());
    ...
    {
        Ioc.Default.GetRequiredService<ICompositorProvider>().GetWindow().DispatcherQueue.TryEnqueue(() =>
        {
    ...
    {
        Ioc.Default.GetRequiredService<ICompositorProvider>().GetWindow().Show();
    }
