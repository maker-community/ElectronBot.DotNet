...
public class Emoji
{
    ...
    public SoftwareBitmapSource BestPic
    {
        get; set;
    }
    public WriteableBitmap BestPicWB
    {
        get; set;
    }
...
{
    public static EmojiCollection _emojis
    {
        get; set;
    }
    public static Emoji _currentEmoji
    {
        get; set;
    }
    public static int _currentEmojiIndex
    {
        get; set;
    }
}
