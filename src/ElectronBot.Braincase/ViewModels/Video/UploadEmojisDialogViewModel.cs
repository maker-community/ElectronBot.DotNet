...
public class UploadEmojisDialogViewModel : ObservableRecipient
{
    ...
    public UploadEmojisDialogViewModel(ILocalSettingsService localSettingsService,
    ...
    private async void SaveEmojis(string? obj)
    {
        ...
        var eshopService = Ioc.Default.GetRequiredService<IEmojiseShopService>();
