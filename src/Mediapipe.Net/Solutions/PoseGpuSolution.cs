...
namespace Mediapipe.Net.Solutions
{
    ...
    public class PoseGpuSolution : GpuSolution, IComputingSolution<PoseOutput>
    {
        private static readonly string graphPath = "mediapipe/modules/pose_landmark/pose_landmark_gpu.pbtxt";
