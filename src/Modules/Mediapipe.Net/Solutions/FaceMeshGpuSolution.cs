...
{
    /// <summary>
    /// Face Mesh solution running on the GPU.
    /// </summary>
    ...
    public class FaceMeshGpuSolution : GpuSolution, IComputingSolution<List<NormalizedLandmarkList>?>
    {
        private static readonly string graphPath = "mediapipe/modules/face_landmark/face_landmark_front_gpu.pbtxt";
